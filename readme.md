...
- WordPress has a robust plugin [API (Application Programming Interface)](https://developer.wordpress.org/plugins/) that makes extending the code easy. If you are a developer interested in utilizing this, see the [Plugin Developer Handbook](https://developer.wordpress.org/plugins/). You shouldn't modify any of the core code.
...
WordPress is free software, and is released under the terms of the [GPL (GNU General Public License) version 2](license.txt) or (at your option) any later version.
